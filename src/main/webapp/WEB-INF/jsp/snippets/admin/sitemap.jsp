...
<!--[if lt IE 9]>
    ...
    <![endif]-->
<% 
List<Map<String, ? extends Object>> templates=(List<Map<String, ? extends Object>>)request.getAttribute("templates");  
%>
<script>
<% 
ObjectMapper mapper = new ObjectMapper();
String templatesJson = mapper.writeValueAsString(templates);
%>
...
<body>
	...
	<div id='slashBar' class="container">
		...
		<div class="row">
				...
				<ul class="nav-bar">
					...
					<li class="has-flyout">
						...
						<div class="flyout small">
				 			...
				 			<div style='background:#FFFFCC;padding:2px'>
								We'll build this menu from the sitemap RESTful web service, yea baby!
				 			</div>
				 		</div>
					</li>
					<li>
			...
			<div class="one columns hide-on-mobile">
				<div class="actions">
	...
	<script src="../../javascripts/jquery.dynatree.min.js"></script>
	<script src="../../javascripts/admin/sitemap.js"></script>
	<script src="../../javascripts/admin/page.js"></script>
