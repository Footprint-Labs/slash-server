...
<body>
	...
	<div class="container" id="slashMain">
		...
		<div class="row" >
			<div class="eight columns" >
					...
					<select data-bind="options: $root.templates, optionsValue: 'id', optionsText: 'name', value: 'selectedTemplate'"></select>
					<label>Template name</label><br/>
					<div ></div>
					<label>Template markup</label><br/>
					<div ></div>
			</div>
			<div class="four columns" ></div>
		</div>
	...
	<script src="../../javascripts/admin/knockout-2.0.0.js"></script>
	<script src="../../javascripts/admin/shCore.js"></script>
	<script src="../../javascripts/admin/shBrushXml.js"></script>
	
	
	<script src="../../javascripts/admin/templatev3.js"></script>
</body>
</html>
